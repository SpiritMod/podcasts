                        ...
                        <div className={styles.top}>
                            <div className={styles.data}>
                                ...
                                <div className={styles.description}>Друзья, всем привет!
                                    Это подкаст от компании Parimatch. Будем говорить о спорте, вернее о том, что сейчас осталось от этого спорта.
                                    Нам, как вы понимаете, от этого факта не весело, но это не означает, что мы не продолжаем улыбаться :)</div>
                            </div>
                        </div>
            ...
            <div className={styles.info}>
                <Tabs defaultActiveKey="1">
                    ...
                    <TabPane tab="TRANSCRIPT" key="2">
                        <div className="s-content transcript">
                            <p>
